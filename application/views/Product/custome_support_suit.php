                                ...
                                <div class="customization_items customization_items_elements cuff_collar_area_elements">
                                    <div class="col-md-4 col-xs-6 custome_element_col">
                                        <div class="item elementItem  "  ng-click='selectCollarCuffInsert("Collar Insert", "No")'>
                                            <div >
                                                <div class="elementStyle customization_box_element {{  ele.title == selecteElements[screencustom.fabric][k.title].title?'activestyle' :'noselected' }}" style="background:url('<?php echo base_url(); ?>assets/images/customization_suit/{{selecteElements[screencustom.fabric]['Collar'].image}}')" > </div>
                                                <div class='customization_title'>
                                                    No Collar Insert
                                                </div>
                                            </div>
                                ...
                                <div class="customization_items customization_items_elements cuff_collar_area_elements">
                                    ...
                                    <div class="col-md-4 col-xs-6 custome_element_col" >
                                        <div class="item elementItem  "  ng-click='selectCollarCuffInsert("Cuff Insert", "No")'>
                                            <div >
                                                <div class="elementStyle customization_box_element {{  ele.title == selecteElements[screencustom.fabric][k.title].title?'activestyle' :'noselected' }}" style="background:url('<?php echo base_url(); ?>assets/images/customization_suit/{{selecteElements[screencustom.fabric]['Cuff & Sleeve'].image}}')" > </div>
                                                <div class='customization_title'>
                                                    No Cuff Insert
                                                </div>
                                            </div>
